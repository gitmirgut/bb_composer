...
pts_left = cv2.transform(pts_left, nc.rot_mat_l)
pts_right = cv2.transform(pts_right, nc.rot_mat_r)
img_left_d = draw_makers(img_left, pts_left)
img_right_d = draw_makers(img_right, pts_right)
...
pts_left = cv2.perspectiveTransform(pts_left, nc.homo_mat_l)
pts_right = cv2.perspectiveTransform(pts_right, nc.homo_mat_r)
print(pts_left)
print(nc.homo_mat_l)

# pts_left = cv2.perspectiveTransform(pts_left, nc.homo_mat_l)
# pts_right = cv2.perspectiveTransformsform(pts_right, nc.homo_mat_r)
