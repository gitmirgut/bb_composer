...
print('rect')
img_l, right_img = nc._rectify_images(img_left_org, img_right_org)
print('rot')
img_l, right_img = nc._rotate_images(img_l, right_img)
print('compose')
result = nc.composePanorama(img_l, right_img)
